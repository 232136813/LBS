...
public interface SpatialIndex {
   ...
   */
  public boolean add(float x, float y, long id, long timeStamp, byte type);
...
//  public void nearest(float x, float y, TLongProcedure v, float furthestDistance);
   ...
   * no matter how far away, although this will slow down the algorithm.
   */
  public void nearestN(float x, float y, TLongFloatProcedure v, int n, float distance, final PriorityQueue pq);
   ...
   */
  public void nearestNUnsorted(float x, float y, TLongFloatProcedure v, int n, float distance, final PriorityQueue pq);
