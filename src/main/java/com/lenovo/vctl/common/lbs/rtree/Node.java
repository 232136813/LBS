...
public String toString() {
	return "Node [nodeId=" + nodeId + ", mbrMinX=" + mbrMinX + ", mbrMinY="
			+ mbrMinY + ", mbrMaxX=" + mbrMaxX + ", mbrMaxY=" + mbrMaxY
			+ ", entriesMinX=" + Arrays.toString(entriesMinX)
			+ ", entriesMinY=" + Arrays.toString(entriesMinY)
			+ ", entriesMaxX=" + Arrays.toString(entriesMaxX)
			+ ", entriesMaxY=" + Arrays.toString(entriesMaxY) + ", ids="
			+ Arrays.toString(ids) + ", level=" + level + ", entryCount="
			+ entryCount + "]";
}
